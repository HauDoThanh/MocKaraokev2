...
extern "C" JNIEXPORT void Java_com_haudo_testsuperpoweredxx_Main2Activity_SetTempFolder(JNIEnv *javaEnvironment, jobject __unused obj, jstring path) {
...
extern "C" JNIEXPORT void Java_com_haudo_testsuperpoweredxx_Main2Activity_StartAudio(JNIEnv * __unused javaEnvironment, jobject __unused obj, jint samplerate, jint buffersize) {
...
extern "C" JNIEXPORT void Java_com_haudo_testsuperpoweredxx_Main2Activity_onForeground(JNIEnv * __unused javaEnvironment, jobject __unused obj) {
    audioIO->onForeground();
}

extern "C" JNIEXPORT void Java_com_haudo_testsuperpoweredxx_Main2Activity_onBackground(JNIEnv * __unused javaEnvironment, jobject __unused obj) {
    audioIO->onBackground();
}

extern "C" JNIEXPORT void Java_com_haudo_testsuperpoweredxx_Main2Activity_Open(JNIEnv *javaEnvironment, jobject __unused obj, jstring url) {
    const char *str = javaEnvironment->GetStringUTFChars(url, 0);
    player->openHLS(str);
    javaEnvironment->ReleaseStringUTFChars(url, str);
}

extern "C" JNIEXPORT void Java_com_haudo_testsuperpoweredxx_Main2Activity_Seek(JNIEnv * __unused javaEnvironment, jobject __unused obj, jfloat percent) {
    player->seek(percent);
}

extern "C" JNIEXPORT void Java_com_haudo_testsuperpoweredxx_Main2Activity_SetDownloadStrategy(JNIEnv * __unused javaEnvironment, jobject __unused obj, jint optionIndex) {
    switch (optionIndex) {
...
extern "C" JNIEXPORT void Java_com_haudo_testsuperpoweredxx_Main2Activity_PlayPause(JNIEnv * __unused javaEnvironment, jobject __unused obj) {
    player->togglePlayback();
    SuperpoweredCPU::setSustainedPerformanceMode(player->playing);
}

extern "C" JNIEXPORT void Java_com_haudo_testsuperpoweredxx_Main2Activity_SetSpeed(JNIEnv * __unused javaEnvironment, jobject __unused obj, jboolean fast) {
...
Java_com_superpowered_hlsexample_Main2Activity_SetTempFolder(JNIEnv *env, jobject instance,
                                                             jstring path_) {
...
extern "C" JNIEXPORT void Java_com_haudo_testsuperpoweredxx_Main2Activity_UpdateStatus(JNIEnv *javaEnvironment, jobject obj) {
...
extern "C" JNIEXPORT void Java_com_haudo_testsuperpoweredxx_Main2Activity_Cleanup(JNIEnv * __unused javaEnvironment, jobject __unused obj) {
    delete audioIO;
    delete player;
    free(floatBuffer);
